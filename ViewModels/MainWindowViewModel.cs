...
namespace MyClock.ViewModels
{
    public class MainWindowViewModel : ViewModel
    {
        ...
        DispatcherTimer dispatcherTime = new DispatcherTimer(DispatcherPriority.Normal);
        ...
        private void TimerTick(object sender, EventArgs e)
        {
            ...
            SecondString = now.ToString("ss");
            DateString = now.ToString("yyyy/MM/dd dddd");
        }


        #region TimeString変更通知プロパティ
